...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Testcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"testcointools.com", "dnsseed.testcointools.com"},
    {"testcoinpool.org", "dnsseed.testcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"testcointools.com", "testnet-seed.testcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Testcoin is probably already running."), addrBind.ToString().c_str());
        else
